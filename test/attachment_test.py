...
class AttachmentTest(unittest.TestCase):
    ...
    def test_AttachmentInitcontent_type(self):
        attachment = Attachment(usage_type='test', display=None, description=None,
                                content_type='test')
        self.assertEqual(attachment.usage_type, 'test')
        self.assertIsNone(attachment.display)
    ...
    def test_AttachmetInitSha2(self):
        attachment = Attachment(usage_type='test', display=None, description=None,
                                content_type='test', length=1, sha2='test')
        self.assertEqual(attachment.usage_type, 'test')
        self.assertIsNone(attachment.display)
        self.assertEqual(attachment.content_type, 'test')
        self.assertEqual(attachment.length, 1)
    ...
    def test_AttachmentInitEmptyDisplay(self):
        attachment = Attachment(usage_type='test', display={}, description=None,
                                content_type='test', length=1, sha2='test',
                                fileurl='test.com/test.pdf')
        self.assertEqual(attachment.usage_type, 'test')
    ...
    def test_AttachmentInitEmptyDescription(self):
        attachment = Attachment(usage_type='test', display=None, description={},
                                content_type='test', length=1, sha2='test',
                                fileurl='test.com/test.pdf')
        self.assertEqual(attachment.usage_type, 'test')
    ...
    def test_AttachmentInitAnonDisplay(self):
        attachment = Attachment(usage_type='test', display={"en-US": "test"}, description=None,
                                content_type='test', length=1, sha2='test',
                                fileurl='test.com/test.pdf')
        self.assertEqual(attachment.usage_type, 'test')
        self.assertEqual(attachment.content_type, 'test')
    ...
    def test_AttachmentInitAnonDescription(self):
        attachment = Attachment(usage_type='test', display=None, description={"en-US": "test"},
                                content_type='test', length=1, sha2='test',
                                fileurl='test.com/test.pdf')
        self.assertEqual(attachment.usage_type, 'test')
        self.assertIsNone(attachment.display)
    ...
    def test_AttachmentInitDisplay(self):
        attachment = Attachment(usage_type='test', display=LanguageMap({"en-US": "test"}),
                                description=None, content_type='test', length=1, sha2='test',
                                fileurl='test.com/test.pdf')
        self.assertEqual(attachment.usage_type, 'test')
        self.assertEqual(attachment.content_type, 'test')
        self.assertEqual(attachment.length, 1)
    ...
    def test_AttachmentInitDescription(self):
        attachment = Attachment(usage_type='test', display=None,
                                description=LanguageMap({'en-US': 'test'}), content_type='test',
    ...
    def test_fromJSONSha2(self):
        attachment = Attachment.from_json(
            '{"usage_type":"test", "content_type":"test", "length":1, "sha2":"test"}')
        self.assertEqual(attachment.usage_type, 'test')
        self.assertIsNone(attachment.display)
        self.assertEqual(attachment.content_type, 'test')
        self.assertEqual(attachment.length, 1)
    ...
    def test_fromJSONDisplay(self):
        attachment = Attachment.from_json(
            '{"usage_type":"test", "content_type":"test", "length":1, "sha2":"test", "fileurl":"test", "display":{"en-US":"test"}}')
        self.assertEqual(attachment.usage_type, 'test')
        self.assertEqual(attachment.content_type, 'test')
        self.assertEqual(attachment.length, 1)
        self.assertEqual(attachment.sha2, 'test')
    ...
    def test_fromJSONDescription(self):
        attachment = Attachment.from_json(
            '{"usage_type":"test", "content_type":"test", "length":1, "sha2":"test", "fileurl":"test", "display":{"en-US":"test"}, "description":{"en-US":"test"}}')
        self.assertEqual(attachment.usage_type, 'test')
        self.assertEqual(attachment.content_type, 'test')
        self.assertEqual(attachment.length, 1)
        self.assertEqual(attachment.sha2, 'test')
    ...
    def test_ToJSON(self):
        attachment = Attachment(
            **{"usage_type": "test", "content_type": "test", "length": 1, "sha2": "test",
               "fileurl": "test", "display": {"en-US": "test"}, "description": {"en-US": "test"}})
